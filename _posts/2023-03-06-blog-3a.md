...
```
Most APIs have many different endpoings. This particular one has 21 to choose from, so I played around with the live demo for a while until I figured out which ones would give me the information I wanted. 

### Step 2: Getting the Parameters

Each artist, album, song, playlist, and user on Spotify has a unique identification code. In order to 
