...
I also wanted to get some data about how well Taylor Swift's songs have done on the charts. I think it will be interesting to compare how the <a href="https://www.billboard.com/artist/taylor-swift/chart-history/hsi/" billboard rankings</a> compare to the Spotify play counts, and if they are comprable, I could use billboard rankings as an alternate response variable to play count.
