...
For each one you sign up for, you'll get a unique API key. This is how you'll connect to each specific API from whatever coding platform you're using (in this case, Python Jupyter Notebooks). 
