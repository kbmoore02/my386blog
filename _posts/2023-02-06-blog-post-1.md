...
```
This process simulates taking a number of samples $(n)$ and determining the probability of any given number of successes $(0:n)$, given the prior distribution. 
...
Let's consider an example where we are interested in the proportion of people in the United States who are multi-lingual. We create a prior distribution of $\theta\~Beta(a=10,b=40)$, suggesting that 20% of US residents are multi-lingual. The distribution would look like this:
